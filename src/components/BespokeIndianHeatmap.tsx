...
export default function BespokeIndianHeatmap({ exchange }: { exchange: 'NSE' | 'BSE' }) {
  ...
  const nseSymbols = [
    ...
    "TITAN.NS", "ASIANPAINT.NS", "ADANIENT.NS", "ONGC.NS", "BAJAJFINSV.NS",
    "WIPRO.NS", "ADANIPORTS.NS", "NESTLEIND.NS", "POWERGRID.NS", "JSWSTEEL.NS",
    "DMART.NS", "COALINDIA.NS", "TATAMOTORS.NS", "BAJAJ-AUTO.NS", "SBILIFE.NS",
    "HINDALCO.NS", "HDFCLIFE.NS", "INDIGO.NS", "TATASTEEL.NS", "GRASIM.NS",
    "TRENT.NS", "SIEMENS.NS", "TECHM.NS", "PIDILITIND.NS", "ZOMATO.NS",
    "HAL.NS", "BEL.NS", "ADANIGREEN.NS", "BPCL.NS", "IOC.NS",
    "HDFCAMC.NS", "DRREDDY.NS", "CIPLA.NS", "BRITANNIA.NS", "EICHERMOT.NS",
    "DLF.NS", "GODREJCP.NS", "AMBUJACEM.NS", "DIVISLAB.NS", "APOLLOHOSP.NS",
    "SHRIRAMFIN.NS", "ADANIPOWER.NS", "TVSMOTOR.NS", "ICICIPRULI.NS", "VBL.NS",
    "JIOFIN.NS", "HEROMOTOCO.NS", "CHOLAFIN.NS", "BAJAJHLDNG.NS", "IRFC.NS",
    "PFC.NS", "RECLTD.NS", "INDUSINDBK.NS", "TATACONSUM.NS", "BANKBARODA.NS",
    "PNB.NS", "GAIL.NS", "CGPOWER.NS", "NAUKRI.NS", "HAVELLS.NS",
    "LODHA.NS", "BOSCHLTD.NS", "AMBANI.NS", "ADANIENSOL.NS", "ATGL.NS",
    "JINDALSTEL.NS", "TATAPOWER.NS", "VEDL.NS", "JSWENERGY.NS", "IOB.NS",
    "CANBK.NS", "SHREECEM.NS", "ZYDUSLIFE.NS", "ICICIGI.NS", "BAJAJHFL.NS",
    "MOTHERSON.NS", "INDHOTEL.NS", "MANKIND.NS", "LTIM.NS", "MAXHEALTH.NS",
    "TORRENTPHARMA.NS"
  ];

  const bseSymbols = [
    "RELIANCE.BO", "TCS.BO", "HDFCBANK.BO", "BHARTIARTL.BO", "ICICIBANK.BO", 
    "INFY.BO", "SBIN.BO", "ITC.BO", "HINDUNILVR.BO", "LT.BO", 
    "BAJFINANCE.BO", "HCLTECH.BO", "KOTAKBANK.BO", "SUNPHARMA.BO", "MARUTI.BO", 
    "M&M.BO", "AXISBANK.BO", "ULTRACEMCO.BO", "NTPC.BO", "TITAN.BO", 
    "ASIANPAINT.BO", "BAJAJFINSV.BO", "WIPRO.BO", "POWERGRID.BO", "JSWSTEEL.BO", 
    "TATAMOTORS.BO", "TATASTEEL.BO", "TECHM.BO", "INDUSINDBK.BO", "TATACONSUM.BO"
  ];
