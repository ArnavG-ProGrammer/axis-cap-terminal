...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-[#0a0a0a] border-r border-[#262626] flex flex-col z-50">
      <div className="p-6 pb-2 relative">
        <div className="flex items-center justify-center mb-8 relative">
            <img 
               src="/logo_transparent.png" 
               alt="AXIS CAP" 
               className="w-[85%] px-2 h-auto object-contain filter drop-shadow-[0_0_15px_rgba(52,215,74,0.2)]" 
            />
        </div>
