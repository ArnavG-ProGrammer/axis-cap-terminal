...
const EXTENDED_ASSETS = [
   ...
   { symbol: "AMZN", name: "Amazon", type: "EQUITY", price: 178.25, change: 1.8, region: "US" },
   { symbol: "META", name: "Meta Platforms", type: "EQUITY", price: 505.40, change: 0.95, region: "US" },
   { symbol: "GOOGL", name: "Alphabet", type: "EQUITY", price: 155.72, change: 0.65, region: "US" },
   { symbol: "AMD", name: "AMD Inc", type: "EQUITY", price: 165.20, change: -0.5, region: "US" },
   { symbol: "INTC", name: "Intel Corp", type: "EQUITY", price: 34.50, change: -1.2, region: "US" },
   { symbol: "NFLX", name: "Netflix Inc", type: "EQUITY", price: 615.30, change: 1.1, region: "US" },
   // US Finance
   { symbol: "JPM", name: "JPMorgan Chase", type: "EQUITY", price: 195.50, change: 0.2, region: "US" },
   { symbol: "BAC", name: "Bank of America", type: "EQUITY", price: 37.80, change: 0.5, region: "US" },
   { symbol: "GS", name: "Goldman Sachs", type: "EQUITY", price: 412.30, change: 1.2, region: "US" },
   { symbol: "V", name: "Visa Inc", type: "EQUITY", price: 275.40, change: 0.8, region: "US" },
   ...
   { symbol: "ITC.NS", name: "ITC Limited", type: "EQUITY", price: 425.30, change: 0.2, region: "INDIA" },
   { symbol: "BAJFINANCE.NS", name: "Bajaj Finance", type: "EQUITY", price: 7120.00, change: -1.2, region: "INDIA" },
   { symbol: "LART.NS", name: "Larsen & Toubro", type: "EQUITY", price: 3605.50, change: 0.9, region: "INDIA" },
   { symbol: "AXISBANK.NS", name: "Axis Bank", type: "EQUITY", price: 1120.50, change: 0.6, region: "INDIA" },
   { symbol: "MARUTI.NS", name: "Maruti Suzuki", type: "EQUITY", price: 12500.00, change: 1.8, region: "INDIA" },
   { symbol: "KOTAKBANK.NS", name: "Kotak Mahindra", type: "EQUITY", price: 1650.00, change: -0.5, region: "INDIA" },
   ...
   { symbol: "AUDUSD=X", name: "AUD/USD", type: "FOREX", price: 0.65, change: 0.2, region: "GLOBAL" },
   ...
   { symbol: "ADA-USD", name: "Cardano", type: "CRYPTO", price: 0.45, change: 1.1, region: "GLOBAL" },
   { symbol: "DOGE-USD", name: "Dogecoin", type: "CRYPTO", price: 0.16, change: -2.3, region: "GLOBAL" },
...
export default function ExplorerPage() {
   ...
   let filteredFeatured = EXTENDED_ASSETS.filter(a => {
   ...
   return (
      <>
         ...
         <div className="max-w-7xl mx-auto pb-20 space-y-6">
            ...
            {isQuickAddMode ? (
               <SwipeDeck assets={filteredFeatured} onExit={() => setIsQuickAddMode(false)} />
            ) : (
               <>
...
// ---------------------------------------------------------
// SWIPE DECK COMPONENT (Tinder-Style)
// ---------------------------------------------------------
function SwipeDeck({ assets, onExit }: { assets: any[], onExit: () => void }) {
  const [deck, setDeck] = useState([...assets].sort(() => Math.random() - 0.5));
  ...
  if (deck.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-[500px] border border-[#262626] rounded-2xl bg-[#0a0a0a]">
         <Check className="text-[#34d74a] mb-4" size={48} />
         <h2 className="text-2xl font-bold text-white mb-2">Deck Completed</h2>
         <p className="text-gray-400 mb-6">You have swiped through all available assets in this sector.</p>
  ...
  return (
    <div className="relative h-[600px] w-full max-w-md mx-auto flex items-center justify-center perspective-1000">
      ...
      >
         <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-lg text-gray-400 font-medium mt-1">{currentAsset.name}</p>
            </div>
         ...
         <div className="flex justify-between items-center px-4 border-t border-[#262626] pt-6">
            <div className="flex flex-col items-center gap-2">
               <div className="w-14 h-14 rounded-full bg-[#111] border border-[#262626] flex items-center justify-center text-[#d73434]">
                  <X size={24} />
               </div>
               <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">Reject (Left)</span>
            </div>
            <div className="flex flex-col items-center gap-2">
               <div className="w-14 h-14 rounded-full bg-[#34d74a]/10 border border-[#34d74a]/30 flex items-center justify-center text-[#34d74a]">
                  <Check size={24} />
               </div>
